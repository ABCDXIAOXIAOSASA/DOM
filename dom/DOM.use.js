...
function ul_lis_not(ultag, arr){
    ...
    obj.ul_lis_not = ul_lis_not;
	obj.enode = enode;
    obj.node = node;
    obj.g_num = g_num;
    obj.big1 = big1;
    obj.big1n = big1n;
    obj.all_big1 = all_big1;
	obj.next = next;
	obj.nexte = nexte;
	obj.prev = prev;
	obj.preve = preve;
	...
	obj.is_number = is_number;
	obj.is_object = is_object;
	obj.is_function = is_function;
	obj.is_regexp = is_regexp;
	obj.is_boolean = is_boolean;
	obj.is_date = is_date;
	obj.is_map = is_map;
	obj.is_set = is_set;
	obj.is_list = is_list;
	obj.is_null = is_null;
	obj.is_undefined = is_undefined;
	obj.is_enode = is_enode;
	obj.is_tnode = is_tnode;
	obj.is_cnode = is_cnode;
	obj.is_empty = is_empty;
	obj.is_ctnode = is_ctnode;
	obj.is_cenode = is_cenode;
	obj.is_ccnode = is_ccnode;
	obj.is_cdf  = is_cdf;
	obj.lv1len = lv1len;
	obj.lv1elen = lv1elen;
	obj.i = i;
	...
	obj.string1 = string1;
	obj.string2 = string2;
	obj.tuoFengTo = tuoFengTo;
	obj.toTuoFeng = toTuoFeng;
	obj.rep = rep; 
	obj.rmv_0str0 = rmv_0str0;
	obj.trim = trim;
	obj.rmv_0item0 = rmv_0item0;
	obj.rmv_L = rmv_L;
	obj.count_L = count_L;
	obj.own_L = own_L;
	obj.L = L;
	...
	obj.name = name;
	obj.class_ = class_;
	obj.own_class = own_class;
	obj.a_class = a_class;
	obj.g_class = g_class;
	obj.rmv_class = rmv_class;
	obj.cnode = cnode;
	obj.tnode = tnode;
	obj.dfnode = dfnode;
	obj.list = list;
	...
	obj.g_cnode = g_cnode;
	obj.rmv_0item0 = rmv_0item0;
	obj.a_style_attr = a_style_attr;
	obj.a_split = a_split;
	obj.g_scrollTop = g_scrollTop; 
	obj.g_innerText = g_innerText;
	obj.g_txt = g_txt;
	obj.g_attr = g_attr;
	obj.g_attrs = g_attrs;
	obj.styleSheet = styleSheet;
	obj.rules = rules;
	obj.g_style_attr = g_style_attr;
	obj.range = range;
	obj.a_style_css = a_style_css;
	obj.a_script_js = a_script_js;
	obj.a_cnode = a_cnode;
	obj.a_prev = a_prev;
	obj.a_next = a_next;
	obj.a_first = a_first;
	...
	obj.replace = replace;
	obj.remove = remove;
	obj.set_scrollTop = set_scrollTop;
	obj.set_scrollLeft = set_scrollLeft;
	obj.rmv_attr = rmv_attr;
	obj.rmv_rule = rmv_rule;
	obj.rmv_style_attr = rmv_style_attr;
	obj.com_css = com_css;
	obj.g_i = g_i;
	obj.one_style = one_style;
	obj.change_txt = change_txt;
	obj.reset00 = reset00;
	obj.test = test;
	obj.test_div = test_div;
	obj.a_div = a_div;
	obj.a_inp = a_inp;
	obj.h_end = h_end;
	obj.b_first = b_first;
	...
	obj.id_rule = id_rule;
	obj.l_rules = l_rules;
	obj.l_rules_ori = l_rules_ori;
	obj.ll = ll;
	obj.l_list = l_list;
	obj.l_nt = l_nt;
	obj.w = w;
	obj.l_txt = l_txt;
	obj.l_style_attrs = l_style_attrs;
	obj.l_offset = l_offset;
	obj.show_msg = show_msg;
	obj.body = body; 
	obj.a_title_txt = a_title_txt;
	obj.howmanysheet = howmanysheet;
	obj.id_event = id_event;
	obj.click = click;
	obj.g_body_lv1 = g_body_lv1;
	obj.b_next = b_next;
	obj.keys_len = keys_len;
	obj.title = title;
	obj.meta = meta;
	obj.a_meta = a_meta;
	obj.hrefa = hrefa;
	obj.a_log_error = a_log_error;
	obj.throw_error = throw_error;
	obj.custom_error = custom_error;
	obj.log_error = log_error;
	obj.l_typeof = l_typeof;
	obj.l_t = l_t;
	obj.dir = dir;
	obj.t = t;
	obj.l = l;
	obj.l_list = l_list; 
	obj.l_c = l_c;
	obj.l_sheets = l_sheets;
	obj.l_strict = l_strict;
	obj.l_model = l_model;
	obj.l_attrs = l_attrs;
	obj.l_lv1 = l_lv1;
	obj.l_lv1c = l_lv1c;
	...
	obj.l_txt = l_txt;
	obj.l_style_attrs = l_style_attrs;
	obj.l_style_attr = l_style_attr;
	obj.l_attr = l_attr;
	obj.l_all = l_all;
	obj.l_rules = l_rules;
	obj.l_rules_ori = l_rules_ori;
	obj.l_tag = l_tag;
	obj.l_code10 = l_code10;
	obj.l_arr = l_arr;
	obj.l_obj = l_obj;
	obj.l_0str = l_0str;
	obj.count_0str = count_0str;
	obj.l_split = l_split;
	obj.l_lasti = l_lasti;
	obj.l_i = l_i;
	obj.l_offset = l_offset;
	obj.l_one_list = l_one_list;
	obj.log_one_t = log_one_t;
	obj.print = print;
	obj.l_str = l_str;
	obj.l_len = l_len;
	obj.l_nodeName = l_nodeName;
	obj.l_nodeValue = l_nodeValue;
	obj.l_arr = l_arr;
	obj.l_obj = l_obj;
	obj.lv1t = lv1t;
	obj.test_div = test_div;
	...
	obj.each  = each;
	obj.a_event = a_event;
	obj.rmv_event = rmv_event;
	obj.preventDefault = preventDefault;
	obj.stopPropagation = stopPropagation;
	obj.g_cookie = g_cookie;
	obj.s_cookie = s_cookie;
	obj.rmv_cookie = rmv_cookie;
	obj.get = get;
	obj.post = post;
	obj.s_dataset = s_dataset;
	obj.g_dataset = g_dataset;
	obj.onload = onload;
	obj.domloaded = domloaded;
	obj.g_inner = g_inner;
	obj.show = show;
	obj.hide = hide;
	obj.crt_ul_lis_obj = crt_ul_lis_obj;
	obj.crt_uls_lis_obj = crt_uls_lis_obj;
	obj.nextAll = nextAll;
	obj.clip_array = clip_array;
   return obj;
})();